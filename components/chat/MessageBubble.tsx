...
export const MessageBubble = React.memo(function MessageBubble({ message, onOpenSources, onRetry }: MessageBubbleProps) {
  ...
  return (
    ...
    >
      ...
      {message.role === 'assistant' && message.content && (
        <div className="flex gap-4 justify-start ml-10">
