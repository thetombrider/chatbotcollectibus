...
export async function POST(req: NextRequest) {
  try {
    ...
    // Processa documento in background (potrebbe essere fatto con Edge Function)
    // Per ora facciamo processing sincrono
    try {
      ...
      // Elimina documento se processing fallisce
